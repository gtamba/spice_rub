...
An existing CSPICE installation or download the toolkit package and simply extract the binary. Find an appropriate installation for your architecture {here} [https://naif.jpl.nasa.gov/naif/toolkit_C.html].
...
Move CSPICE binary library to the right extension folder (must be renamed to libcspice.a) :

  mv path/to/cspice.a ext/spice_rub/cspice/lib/libcspice.a
...
Kernel Loading Functions (In development)
